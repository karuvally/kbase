            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <!--    <li class="active">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>{{$value->element}}</a>
                        <?php $sub_permissions=DB::select('select * from sub_permissions where parent_id=?',[$value->id]); ?>
